...
const Navbar = () => {
  ...
  // confirm before actually logging out
  const handleLogout = () => {
    ...
    >
      <div className="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
        ...
        >
          ...
          <li>
            <Link to="/solutions" className="text-white hover:text-[#00C2FF]">
              Solutions
            </Link>
          </li>
          <li>
            <Link to="/why" className="text-white hover:text-[#00C2FF]">
              Why Opsentra?
            </Link>
          </li>
          <li>
            <Link to="/docs" className="text-white hover:text-[#00C2FF]">
              Docs
            </Link>
          </li>
          <li>
            <Link
              to="/usecase"
              className="text-white hover:text-[#00C2FF]"
            >
        ...
        <div className="hidden md:flex items-center gap-4">
          {!user ? (
            <>
              ...
              <Link
                to="/register"
                className="cursor-pointer bg-[#00C2FF] text-black px-4 py-2 rounded-xl hover:bg-white transition"
              >
                Start Free
              </Link>
            </>
        ...
        {/* Mobile burger icon */}
        <div
          className="md:hidden cursor-pointer ml-3 z-50"
